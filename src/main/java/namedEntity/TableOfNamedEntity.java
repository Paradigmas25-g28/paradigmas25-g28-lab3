...
public class TableOfNamedEntity {
  ...
  public void prettyPrint() {
    ...
    /*
     * Para cada feed, imprime una tabla con las entidades nombradas de cada
     * articulo, y su frecuencia en el articulo.
     */
    ...
    /*
     * Para cada feed, imprime una tabla con la frecuencia de cada category y de
     * cada topic.
     */
  ...
  public static Map<String, Integer> buildCountDict(Feed feed, Heuristic he) {
